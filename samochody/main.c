...
int waliduj_paliwo(const char *paliwo) {
    return strcmp(paliwo, "benzyna") == 0 ||
           strcmp(paliwo, "diesel") == 0 ||
           strcmp(paliwo, "lpg") == 0;
}

void dodaj_samochod(Samochod auta[], int *liczba_samochodow) {
    ...
    do {
        ...
        if (!waliduj_paliwo(s->paliwo)) {
            printf("Niepoprawny rodzaj paliwa. Sprobuj ponownie.\n");
        }
    } while (!waliduj_paliwo(s->paliwo));

    (*liczba_samochodow)++;
}

void wyswietl_samochody(Samochod auta[], int liczba_samochodow) {
    printf("\nLista samochodow:\n");
...
void zapisz_do_pliku(Samochod auta[], int liczba_samochodow, const char *nazwa_pliku) {
...
void wczytaj_z_pliku(Samochod auta[], int *liczba_samochodow, const char *nazwa_pliku) {
...
int main() {
    ...
    do {
        ...
        switch (wybor) {
            case 1:
                dodaj_samochod(auta, &liczba_samochodow);
                break;
            case 2:
                wyswietl_samochody(auta, liczba_samochodow);
                break;
            case 3:
                zapisz_do_pliku(auta, liczba_samochodow, plik);
                break;
            case 4:
                wczytaj_z_pliku(auta, &liczba_samochodow, plik);
                break;
            case 0:
